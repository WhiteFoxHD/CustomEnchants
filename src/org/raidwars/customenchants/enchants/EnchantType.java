...
public enum EnchantType {
	...
	STRENGTH(ChatColor.GRAY + "Strength I", ImmutableSet.of(Material.DIAMOND_LEGGINGS, Material.DIAMOND_CHESTPLATE), new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 100000, 0)),
	STRENGTH2(ChatColor.GRAY + "Strength II", ImmutableSet.of(Material.DIAMOND_LEGGINGS, Material.DIAMOND_CHESTPLATE), new PotionEffect(PotionEffectType.INCREASE_DAMAGE, 100000, 1)),
	SPEED(ChatColor.GRAY + "Speed I", ImmutableSet.of(Material.DIAMOND_BOOTS), new PotionEffect(PotionEffectType.SPEED, 100000, 0)),
	SPEED2(ChatColor.GRAY + "Speed II", ImmutableSet.of(Material.DIAMOND_BOOTS), new PotionEffect(PotionEffectType.SPEED, 100000, 1)),
